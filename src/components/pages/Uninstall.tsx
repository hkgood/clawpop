    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        <motion.div
          ...
          className="w-20 h-20 rounded-full bg-status-success/20 flex items-center justify-center mb-6"
        >
  ...
  if (isInstalled === false) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        >
          <X size={40} className="text-text-secondary" />
        </motion.div>
  ...
  return (
    <div className="flex-1 flex flex-col px-8 py-6 overflow-y-auto">
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
      >
        <h2 className="text-2xl font-bold mb-2">{t.uninstall.title}</h2>
        <p className="text-text-secondary mb-2">{t.uninstall.subtitle}</p>
        
        <div className="flex items-center gap-2 text-status-warning text-sm mt-4">
        ...
        {options.map((option, index) => (
          ...
          >
            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
              option.checked ? 'bg-brand-start/30' : 'bg-white/10'
            }`}>
              <option.icon size={20} className={option.checked ? 'text-brand-start' : 'text-text-secondary'} />
            </div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-lg">确认卸载</h3>
                  <p className="text-text-secondary text-sm">{t.uninstall.warning}</p>
                </div>
              </div>
