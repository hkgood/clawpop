...
export function SettingsPage() {
  ...
  return (
    <div className="flex-1 flex flex-col px-8 py-6 overflow-y-auto">
      ...
      >
        <h2 className="text-2xl font-bold mb-2 text-primary">{t.settings.title}</h2>
      ...
      >
        ...
        <div className="rounded-xl p-4 border border-default bg-card">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className={`w-3 h-3 rounded-full ${
                serviceStatus === 'running' ? 'bg-success animate-pulse' :
                serviceStatus === 'stopped' ? 'bg-hover' : 'bg-warning animate-pulse'
              }`} />
      ...
      >
        ...
        <div className="rounded-xl p-4 border border-default bg-card">
          <div className="flex items-center justify-between">
            <span className="text-primary">界面语言</span>
            <div className="flex gap-2">
              <button
      ...
      >
        ...
        <div className="rounded-xl p-4 border border-default bg-card">
          <div className="flex items-center justify-between">
            <div>
              <div className="font-medium text-primary">导入/导出配置</div>
              <div className="text-sm text-secondary">备份或恢复你的设置</div>
            </div>
            <div className="flex gap-2">
