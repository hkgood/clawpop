  ...
  if (checking) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        ...
        <p className="text-secondary">检测安装状态...</p>
      </div>
    )
  }
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-8">
      <motion.div
        ...
        className="w-32 h-32 rounded-3xl bg-btn-primary flex items-center justify-center mb-10"
      >
        <span className="text-btn-primary font-bold text-4xl">CP</span>
      </motion.div>
      ...
      <motion.h1 
        ...
        className="text-4xl font-bold text-center mb-4 tracking-tight text-primary"
      >
        {t.welcome.title}
      </motion.h1>
      ...
      <motion.p 
        ...
        className="text-lg text-center mb-3 text-secondary"
      >
        {t.welcome.subtitle}
      </motion.p>
      ...
      <motion.p 
        ...
        className="text-base text-center mb-8 text-brand font-medium"
      >
        {t.welcome.slogan}
      </motion.p>
